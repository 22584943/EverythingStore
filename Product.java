public class Product {
 ...
 private int price;
	...
	public Product(int id, String SKU, String category, String name, String description, int price) {
		this.id = id;
		this.SKU = SKU;
		this.name = name;
...
//	}
	...
	public String toString() {
		return "ID: " + id + ", SKU: " + SKU + ", CATEGORY: " + category + " , NAME: " + name + ", DESCRIPTION: " + description + ", PRICE: " + price;
	}
